...
Running on a CachyOS desktop (16GB RAM, 12th gen Intel i9, RTX 4070).
...
Both provisioned via cloud-init, with persistent static IPs, reachable from the host via SSH aliases.
